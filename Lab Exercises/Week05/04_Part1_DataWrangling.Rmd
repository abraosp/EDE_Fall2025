...
> Add notes here: To compare the part temperature to current one in order to use data to predict and manipulate data for fure peojctions to inform management 
...
# Add stringAsFactors so the summary can work for charater entries as well. 
...
NTL.phys.data.in.90s <- filter(NTL.phys.data, 
